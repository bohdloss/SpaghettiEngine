...
public class MicrophoneInputStream extends InputStream {
	...
	public MicrophoneInputStream(String deviceName, int format, int frequency, int tempBufferSize,
			int secondaryBufferSize, int emptyBias) {
		// Save arguments
	...
	public MicrophoneInputStream() {
		this(null, DEFAULT_FORMAT, DEFAULT_FREQUENCY, DEFAULT_TEMP_BUFFER_SIZE, DEFAULT_SECONDARY_BUFFER_SIZE,
				DEFAULT_EMPTY_BIAS);
	}
